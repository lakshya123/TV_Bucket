...
public class TvExampleModel
{
    ...
    @Expose
    private List<TvCreatedBy> createdBy = null;
    ...
    @Expose
    private List<TvNetwork> networks = null;
    ...
    @Expose
    private List<TvProductionCompany> productionCompanies = null;
    @SerializedName("seasons")
    @Expose
    private List<TvSeasons> seasons = null;
    ...
    public List<TvProductionCompany> getProductionCompanies() {
        return productionCompanies;
    }

    public void setProductionCompanies(List<TvProductionCompany> productionCompanies) {
